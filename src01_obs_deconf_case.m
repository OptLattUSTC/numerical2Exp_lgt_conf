...
fileAll = dir([pwd,filesep,'analy_res_deconf',filesep,'analy_*.mat']);
nfls = numel(fileAll);
...
% ylim([0.06,0.6])
ylim([0.5,6])
xlabel('Evolution time \itt\rm (ms)','FontSize',16)
ylabel('\langle\itO(t)\rangle','FontSize',16)
...
ylim([1.5,3.5])
xlabel('Evolution time \itt\rm (ms)','FontSize',16)
ylabel('\langle\itM(t)\rangle','FontSize',16)
...
ylim([0.6,5.6])
xlabel('Evolution time \itt\rm (ms)','FontSize',16)
ylabel('\langle\it2 O(t) / M(t)\rangle','FontSize',16)
